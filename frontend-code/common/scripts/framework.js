...
function loadContentBasedOnRole() {
	...
	if (role === 'therapist') {
		...
		navItems = `
            ...
            <li><a href="../therapist-module/patient-management/group-management.php" target="content-frame" data-initial="G">Group Management</a></li>
            <li><a href="../therapist-module/patient-management/patient-list.php" target="content-frame" data-initial="P">Patient Management</a></li>
        `;
		...
		navItems = `
            ...
            <li><a href="../patient-module/dashboard/Patient.php" target="content-frame" data-initial="J">Exercise Tracker</a></li>
            <li><a href="../patient-module/journal-entry/journalentry_page.html" target="content-frame" data-initial="J">Journal Entry</a></li>
            <li><a href="../patient-module/sleep-tracking/Home.html" target="content-frame" data-initial="S">Sleep Tracking</a></li>
            <li><a href="../patient-module/eating-habit/log-food-dashboard.php" target="content-frame" data-initial="E">Eating Habit</a></li>
        `;
